        ...
        >
            ...
            >
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full mb-4">
                        <div class="text-lg"><span>備註</span></div>
                        <textarea
                            x-model="productNote"
                            type="text"
                            class="w-full h-20 px-4 py-2 flex-1 rounded bg-[#f8f8f8] border border-[#e5e5e5] text-lg resize-none"
                        ></textarea>
                    </div>
                </div>
                <!-- Buttons -->
                <div class="mt-4 flex space-x-2 justify-center">
                    <x-disablable-button type="outline" @click="closeProductModal">
                        取 消
                    </x-disablable-button>
                    <button
                        @click="addFromProductList"
                        :disabled="!canAddToCart"
                        :class="canAddToCart ? 'bg-[#0f375b]' : 'bg-[#e5e5e5]'"
                        class="flex flex-1 justify-center items-center px-8 xl:px-16 py-2 w-full rounded"
                    >
                        <span
                            :class="canAddToCart ? 'text-white' : 'text-[#8d8d8d]'"
