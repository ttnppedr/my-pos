                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex justify-around items-center">
                                <button
                                    ...
                                    class="flex justify-center items-center rounded w-[44px] h-[44px] {{$this->isEditing ? 'bg-[#fce2e2]' : 'bg-[#e5e5e5]'}}"
                                    {{$this->isEditing ? '' : 'disabled'}}
                                >
                                    <svg width="22" height="4" viewBox="0 0 22 4" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            ...
                                            fill="{{$this->isEditing ? '#A71F23 ' : '#8d8d8d'}}" fill-rule="nonzero"/>
                                    </svg>
                                </button>
                                <div class="px-3">
                                    <input type="text"
                                ...
                                <button
                                    ...
                                    class="flex justify-center items-center rounded w-[44px] h-[44px] {{$this->isEditing ? 'bg-[#d8f3e6]' : 'bg-[#e5e5e5]'}}"
                                    {{$this->isEditing ? '' : 'disabled'}}
                                >
                                    <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            ...
                                            fill="{{$this->isEditing ? '#006941' : '#8d8d8d'}}" fill-rule="nonzero"/>
                                    </svg>
                                </button>
                            </div>
